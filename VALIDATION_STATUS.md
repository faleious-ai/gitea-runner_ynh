...
- The automated updater has already produced immutable 2.1.0 URLs and SHA-256 values.
...
- Unregistered installations now keep the systemd unit available but are not added to YunoHost service monitoring until `.runner` exists.
